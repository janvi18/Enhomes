...
public class Utils {
    ...
    public static String SUGGESTION_URL = MAIN_URL + "suggestion";
    public static String HOUSE_URL = MAIN_URL + "house";
    public static String VISITOR_URL = MAIN_URL + "visitor";
    public static String DELIVERY_URL = MAIN_URL + "delivery";
    ...
    public static String COMPLAINT_URL = MAIN_URL + "complaint";
}
